...
class LinearRegressionModel:
    ...
    def predict(self, toan_tb: float, van_tb: float, kh_ta_tb: float, type_mon3: int):
        """
        ...
        Args:
            ...
            type_mon3 (int): Loại môn thứ 3 (1: Khoa học, 2: Tiếng Anh).
    ...
    def loadModel(self):
        self.model_d1 = joblib.load("./outputs/LinearRegression/model_d1.pkl")
        self.model_d2 = joblib.load("./outputs/LinearRegression/model_d2.pkl")
        self.model_d3 = joblib.load("./outputs/LinearRegression/model_d3.pkl")
    
    def info(self) -> str:
        return "Linear Regression Model - HSA"
